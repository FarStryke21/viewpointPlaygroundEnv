...
class CoverageEnv(gym.Env):
    def __init__(self, mesh_file, sensor_range, sensor_resolution):
        ...
        self.mesh_bbox = self.mesh.get_axis_aligned_bounding_box()
        self.mesh_bbox = [self.mesh_bbox.min_bound, self.mesh_bbox.max_bound]
    ...
    def create_camera_mesh(self):
        ...
        camera_mesh.triangles = o3d.utility.Vector3iVector(camera_faces)
    ...
    def position_and_orient_camera(self):
        ...
        # Apply rotation
        rotation_matrix = Rotation.from_euler('xyz', [alpha, beta, gamma]).as_matrix()
